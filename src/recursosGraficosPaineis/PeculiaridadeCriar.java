...
public class PeculiaridadeCriar extends Pagina {
	...
	public JPanel GerarPainel() {
		...
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBorda(caracteristica, 3, 0, 1, 2, "Caracteristicas"));
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBorda(modificadorcaracteristica, 3, 1, 1, 2, "Modificador"));
		...
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBorda(modificadores, 3, 3, 1, 2, "Modificadores Inseridos"));
