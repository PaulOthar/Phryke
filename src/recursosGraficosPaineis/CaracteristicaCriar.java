...
public class CaracteristicaCriar extends Pagina {
	...
	public void Funcionalidade() {
		criarregra.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent e) {
			}});
		criarvalor.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent e) {
		...
		Caracteristicareferencial.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent e) {
			if(Caracteristicareferencial.getSelectedItem() == "Atualizar") {
				AtualizarCaracteristicas();
			}
			}});
		Caracteristicareferencial2.addActionListener(new ActionListener() {public void actionPerformed(ActionEvent e) {
