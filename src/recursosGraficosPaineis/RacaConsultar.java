...
public class RacaConsultar extends Pagina {
	...
	public JPanel GerarPainel() {
		...
		super.adicionaraopainel(
				ManipuladorPosicionativo.AdicionarComBordaEScroll(peculiaridades, 1, 2, 1, 1, "Peculiaridades"));
		...
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBordaEScroll(descricaopeculiaridade, 1, 3, 1, 1,
				"Descricao Da Peculiaridade"));
		super.adicionaraopainel(
				ManipuladorPosicionativo.AdicionarComBordaEScroll(descricaoraca, 0, 3, 1, 1, "Descricao Da Raca"));
