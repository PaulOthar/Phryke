...
public class Teste extends Pagina {
	...
	public JScrollPane Gerar() {
		...
		super.adicionaraopainel(
				ManipuladorPosicionativo.AdicionarComBordaEScroll(descricaoraca, 0, 3, 1, 2, "Descricao Da Raca"));
		...
		super.adicionaraopainel(
				ManipuladorPosicionativo.AdicionarComBordaEScroll(custos, 0, 9, 1, 2, "Lista De Custos Inseridos"));

		super.adicionaraopainel(
				ManipuladorPosicionativo.Adicionar(new JLabel("---Definir Caracteristicas---"), 0, 10, 1, 2));

		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBordaEScroll(caracteristica, 0, 11, 1, 1,
				"Lista De Caracteristicas Existentes"));
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBordaEScroll(modificadores, 1, 11, 1, 1,
				"Lista De Modificadores Inseridos"));
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBorda(modificadorcaracteristica, 0, 12, 1, 2,
		...
		super.adicionaraopainel(
				ManipuladorPosicionativo.Adicionar(new JLabel("---Definir Peculiaridades---"), 0, 14, 1, 2));

		super.adicionaraopainel(
				ManipuladorPosicionativo.AdicionarComBorda(segmentos, 0, 15, 1, 2, "Segmento Da Peculiaridade"));
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBordaEScroll(peculiaridade, 0, 16, 1, 1,
				"Peculiaridades Existentes"));
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBordaEScroll(peculiaridades, 1, 16, 1, 1,
				"Peculiaridades Inseridas"));
