...
public class SistemaCriar extends Pagina {
	...
	public void Funcionalidade() {
		botaosistema.addActionListener(new ActionListener() {
			@Override
		...
		botaocaracteristicaa.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
		...
		botaocaracteristicar.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				String caracteristica = (String) caracteristicasexi.getSelectedItem();
		...
		botaosegmentoa.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
		...
		botaosegmentor.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
		...
		caracteristicasexi.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
	...
	public JPanel GerarPainel() {
		...
		super.adicionaraopainel(
				ManipuladorPosicionativo.AdicionarComBordaEScroll(caracteristicas, 1, 4, 1, 1, "Caracteristicas"));
		...
		super.adicionaraopainel(
				ManipuladorPosicionativo.AdicionarComBorda(nomesegmentos, 0, 1, 1, 1, "Nome Do Segmento"));
		...
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBorda(caracteristicasexi, 1, 1, 1, 1,
