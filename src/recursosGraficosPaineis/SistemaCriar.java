...
public class SistemaCriar extends Pagina{
	JTextField nome = new JTextField(),nomesegmentos = new JTextField(),nomecaracteristicas = new JTextField();
	...
	JComboBox<String> opcaosegmento = new JComboBox<String>(new String[] {"Adicionar","Deletar","Editar"}),opcaocaracteristica = new JComboBox<String>(new String[] {"Adicionar","Deletar","Editar"});
	...
	public JPanel GerarPainel() {
		...
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBorda(nomecaracteristicas, 1, 1, 1, 1, "Nome Da Caracteristica"));
