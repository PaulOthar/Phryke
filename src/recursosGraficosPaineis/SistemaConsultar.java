...
public class SistemaConsultar extends Pagina {
	...
	public void Funcionalidade() {
		removerregra.addActionListener(new ActionListener() {
			@Override
		...
		excluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (sistemas.getSelectedItem() != "Atualizar" && sistemas.getSelectedItem() != "Selecione") {
					if (Mensageiro
							.PedirConfirmacao("Deseja Mesmo Excluir o Sistema " + sistemas.getSelectedItem() + "?")) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (sistemas.getSelectedItem() == "Atualizar") {
					...
					for (Caracteristica cc : c) {
						texto.add(cc.getNome() + " : Minimo:" + cc.getValorminimo() + " / Base:" + cc.getValor()
								+ " / Maximo:" + cc.getValormaximo());
					}
					texto.add("\n");
					texto.add("Segmentos:");
	...
	public JPanel GerarPainel() {
		...
		super.adicionaraopainel(
				ManipuladorPosicionativo.AdicionarComBordaEScroll(visualizador, 0, 1, 1, 1, "Estrutura"));
