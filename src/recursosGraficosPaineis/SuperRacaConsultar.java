...
public class SuperRacaConsultar extends Pagina {
	...
	public JPanel GerarPainel() {
		...
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBordaEScroll(peculiaridades, 1, 1, 1, 1, "Peculiaridades"));
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBordaEScroll(superracas, 0, 1, 1, 1, "Super Racas"));
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBordaEScroll(descricaosuperraca, 0, 2, 1, 1, "Descricao Da Super Raca"));
		super.adicionaraopainel(ManipuladorPosicionativo.AdicionarComBordaEScroll(descricaopeculiaridade, 1, 2, 1, 1, "Descricao Da Peculiaridade"));
