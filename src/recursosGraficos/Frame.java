...
public class Frame {
	...
	public static JMenu MenuElemental() {
		...
		menu = InserirItens(menu,"Sistemas",new String[]{"Criar Sistema","Consultar Sistema"},new JPanel[]{new SistemaCriar().GerarPainel(),new SistemaConsultar().GerarPainel()});
		menu = InserirItens(menu,"Caracteristicas",new String[] {"Criar Caracteristicas","Consultar Características"},new JPanel[] {new CaracteristicaCriar().GerarPainel(),new CaracteristicaConsultar().GerarPainel()});
		menu = InserirItens(menu,"Peculiaridades",new String[] {"Criar Peculiaridade","Consultar Peculiaridade"},new JPanel[] {new PeculiaridadeCriar().GerarPainel(),new PeculiaridadeConsultar().GerarPainel()});
