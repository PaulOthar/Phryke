...
public class ManipuladorPosicionativo {
	...
	public static JComponent AdicionarComBorda(JComponent componente, int x, int y, int altura, int largura,
			String titulo) {
		return Adicionar(ManipuladorDeComponente.Borda(componente, titulo), x, y, altura, largura);
	}

	public static JComponent AdicionarComBordaEScroll(JComponent componente, int x, int y, int altura, int largura,
			String titulo) {
