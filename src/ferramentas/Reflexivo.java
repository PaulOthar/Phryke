...
public class Reflexivo {
	// Nao sei Debugar que nem gente, entao vou listar tudo que der para listar,
	// durante a execucao do codigo :V

	public static Field BurlarAcessoDaVariavel(Class<?> classe, String nomevariavel)
	...
	// NAO USAR, POAR
	public static Method BurlarAcessoDoMetodo(Class<?> classe, String nomemetodo)
